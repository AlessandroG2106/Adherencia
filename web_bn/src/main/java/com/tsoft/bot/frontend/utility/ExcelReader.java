...
public class ExcelReader {
    ...
    public static List<HashMap<String, String>> data(String rutaRelativaExcel, String nombreHoja) throws Throwable {
        ...
        } finally { IOUtils.closeQuietly(fs); }

        return mydata;
    }

    public static void writeCellValue(String rutaRelativaExcel, String sheetName, int rowNumber, int cellNumber, String resultText) throws  Throwable{
    ...
    public static void writeInCell(String rutaRelativaExcel, String nombreHoja, String resultText) throws Exception {
        FileInputStream fs;
        ...
        try {
            ...
            int nroFilas = sheet.getPhysicalNumberOfRows();
            int nroColumnas = headerRow.getLastCellNum();
            ...
            for (int i = 1; i < nroFilas; i++) {
                ...
                //XSSFCell currentCell = currentRow.getLastCellNum();

                //currentCell.setCellValue(resultText);
