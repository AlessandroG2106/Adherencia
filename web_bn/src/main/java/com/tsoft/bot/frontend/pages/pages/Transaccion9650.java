...
public class Transaccion9650 extends BaseClass {
    ...
    public Transaccion9650(){
        this.driver = Hook.getDriver();
    }

    public void ingresarDatosPagodeTributoconReciboEfectivoyCheque(String casodeprueba) throws Throwable {
