...
public class GenerateWord {
    ...
    private static final String TEMPLATE            = "/src/main/resources/template/plantilla.png";
...
//            fileOutputStream = new FileOutputStream(FileUtils.getFile(carpeta) + "/Multired Virtual Para Empresas-" + generarSecuencia() + ".docx");
            ...
            run.addPicture(insertTemplate, Document.PICTURE_TYPE_PNG, "1", Units.toEMU(480), Units.toEMU(720));
            run.setFontSize(30);
//            run.setText(name);
