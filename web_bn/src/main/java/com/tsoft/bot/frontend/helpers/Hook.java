...
public class Hook extends Listener {
	...
	private static final String CHROME_DRIVER 	= "/src/main/resources/driver/chrome/70.0/chromedriver.exe";
	private static final String IE_KEY 			= "webdriver.ie.driver";
	private static final String IE_DRIVER 		= "/src/main/resources/driver/ie/1111/IEDriverServer.exe";
...
*/
	...
	public static Screen getScreen(){ return (screen==null)?new Screen() : screen;
	}
